 ...
 * accessing the UI.
 */
class SimpleCountingIdlingResource(@NonNull resourceName: String?) : IdlingResource {

    private var mName: String = checkNotNull(resourceName)
    private val mIsIdleNow: Boolean = false
